    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PROPOSED', 'Proposed'), ('PUBLISHED', 'Published'), ('ARCHIVED', 'Archived')], default='PROPOSED', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('published_at', models.DateTimeField(blank=True, null=True)),
                ('votes_count', models.IntegerField(default=0)),
                ('votes_required', models.IntegerField(default=10)),
                ('tags', models.TextField(blank=True, default='[]')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='proposed_games', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hash_id', models.CharField(blank=True, db_index=True, max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_character', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='received_messages', to='app.character')),
                ('sender_character', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sent_messages', to='app.character')),
            ],
            options={
                'ordering': ['sent_date'],
            },
